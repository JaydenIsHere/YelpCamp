...
//------only for production------------
//store session in the atlas cloud database
...
const app = express()
const sessionconfig = {
  //pass in some configuration object
  store: store,
...
app.use((req, res, next) => {
  //a middleware accept every requiest
...
app.use((err, req, res, next) => {
  //here is handle majority of error includeing when we throw the error
